...
export interface PlaygroundAgent {
    ...
    aiAssert?: (prompt: string, locatePrompt?: string, options?: Record<string, unknown>) => Promise<{
        pass: boolean;
        thought: string;
    }>;
    [key: string]: ((prompt: string, options?: Record<string, unknown>) => Promise<unknown>) | unknown;
}
