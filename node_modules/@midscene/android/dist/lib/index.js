...
`, 'm');
    ...
    async screenshotBase64() {
        ...
        const result = (0, img_namespaceObject.createImgBase64ByFormat)(format, buffer.toString('base64'));
    ...
    async ensureYadb() {
        if (!this.yadbPushed) {
            const adb = await this.getAdb();
            const androidPkgJson = (0, external_node_module_namespaceObject.createRequire)(__rslib_import_meta_url__).resolve('@midscene/android/package.json');
