...
class ScriptPlayer {
    ...
    async playTask(taskStatus, agent) {
        ...
        for(const flowItemIndex in flow){
            ...
            if ('aiAction' in flowItem || 'ai' in flowItem) {
                ...
                (0, utils_namespaceObject.assert)('string' == typeof prompt, 'prompt for aiAction must be a string');
                ...
                (0, utils_namespaceObject.assert)('string' == typeof prompt, 'prompt for aiAssert must be a string');
                ...
                (0, utils_namespaceObject.assert)('string' == typeof prompt, 'prompt for aiQuery must be a string');
                ...
                (0, utils_namespaceObject.assert)('string' == typeof prompt, 'prompt for number must be a string');
                ...
                (0, utils_namespaceObject.assert)('string' == typeof prompt, 'prompt for string must be a string');
                ...
                (0, utils_namespaceObject.assert)('string' == typeof prompt, 'prompt for boolean must be a string');
                ...
                (0, utils_namespaceObject.assert)('string' == typeof prompt, 'prompt for aiAsk must be a string');
                ...
                (0, utils_namespaceObject.assert)('string' == typeof prompt, 'prompt for aiLocate must be a string');
                ...
                (0, utils_namespaceObject.assert)('string' == typeof prompt, 'prompt for aiWaitFor must be a string');
    ...
    constructor(script, setupAgent, onTaskStatusChange, scriptPath){
        ...
        if (utils_namespaceObject.ifInBrowser || utils_namespaceObject.ifInWorker) this.output = void 0;
        else if (null == (_this_target = this.target) ? void 0 : _this_target.output) this.output = (0, external_node_path_namespaceObject.resolve)(process.cwd(), this.target.output);
        else {
